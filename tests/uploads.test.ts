import fs from 'fs';
import type { ResponseLike } from '@valtown/sdk/internal/to-file';
import { toFile } from '@valtown/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@valtown/sdk/core/uploads');
    await expect(
