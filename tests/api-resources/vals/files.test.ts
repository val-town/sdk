...
describe('resource files', () => {
  test('create: only required params', async () => {
    const responsePromise = client.vals.files.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: 'path', type: 'directory' });
  ...
  test('update: only required params', async () => {
    const responsePromise = client.vals.files.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: 'path' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.vals.files.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: 'path', recursive: true });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
