...
import { ValTownError } from './error';
...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: ValTown, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
...
export class PageCursorURL<Item> extends AbstractPage<Item> implements PageCursorURLResponse<Item> {
  ...
  nextPageRequestOptions(): PageRequestOptions | null {
    const urlString = this.links?.next;
...
export class Cursor<Item> extends AbstractPage<Item> implements CursorResponse<Item> {
  ...
  constructor(client: ValTown, response: Response, body: CursorResponse<Item>, options: FinalRequestOptions) {
    super(client, response, body, options);
