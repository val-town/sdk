...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: ValTown): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: ValTown): Logger {
